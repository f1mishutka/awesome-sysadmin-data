...
SHELL := /bin/bash
MARKDOWN_REPOSITORY = Rabenherz112/awesome-sysadmin-markdown
HTML_REPOSITORY = Rabenherz112/awesome-sysadmin-html
...
.PHONY: import # import data from the original list at https://github.com/awesome-foss/awesome-sysadmin
...
.PHONY: awesome_lint_strict # check data against awesome-sysadmin guidelines (strict)
awesome_lint_strict:
	source .venv/bin/activate && \
	hecat --config .hecat/awesome-lint-strict.yml

.PHONY: export_markdown # render markdown export from YAML data (https://github.com/awesome-foss/awesome-sysadmin)
export_markdown:
